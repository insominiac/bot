...
firebase.initializeApp(firebaseConfig);
 ...
 var ikey='-NOBin7n3HsYRmL342z9';
 console.log(ikey)
 database.ref().child('/botform/-NOBin7n3HsYRmL342z9').once('value', function(snapshot) {
...
//var results = msgs.concat(msgs1)
//msgdata.push(results)
...
const handleSubmit = async (e) => {
  ...
  msgs = msgs.concat(getInputVal('promptmsgs'))
