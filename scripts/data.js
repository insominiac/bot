 ...
 database.ref('botform').on('value', function(snapshot) {
   if (snapshot.exists()) {
     ...
     snapshot.forEach(function(data) {
       ...
       content += `<div class="col"><a href="${val.name.toLowerCase()}.html" target="_blank" style="color:transparent"><div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url(${val.imageurl});">
